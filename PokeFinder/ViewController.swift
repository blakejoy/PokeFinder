...
class ViewController: UIViewController,MKMapViewDelegate,CLLocationManagerDelegate {
  ...
  @IBAction func spotPokemon(_ sender: AnyObject) {
    ...
    performSegue(withIdentifier: "UIPresentationController", sender: self)
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    ...
    if segue.identifier == "UIPresentationController"{
      let presVC = segue.destination as? UIPresentationController
      
      presVC?.mapView = mapView
